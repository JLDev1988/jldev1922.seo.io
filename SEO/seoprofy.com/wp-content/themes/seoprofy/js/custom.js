...
if (document.querySelector('.phone')) {
   ...
   inputs.forEach(function(element) {
      window.intlTelInput(element, {
         ...
         utilsScript: window.utilsScript,
      });
...
function send_form(event) {
   ...
   let tel_code = '';
   let tel = this.querySelector('.iti__selected-dial-code');
   if (tel) {
...
const section_contact = document.querySelector('.popup-contact-form .contact-form');
const section_contact_page = document.querySelector('.contact__item.contact-form-block .contact-form');

if (section_contact) section_contact.addEventListener('submit', send_form);
if (section_contact_page) section_contact_page.addEventListener('submit', send_form);